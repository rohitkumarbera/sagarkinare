...
js_url = "https://rohitbera.com/clientwebsite/sagarkinaretajpur/assets/index-BYV110l8.js"
r_js = requests.get(js_url, headers=headers)
print(f"JS {js_url} -> Status: {r_js.status_code} | Size: {len(r_js.content)} bytes")

css_url = "https://rohitbera.com/clientwebsite/sagarkinaretajpur/assets/index-wNpQIhs3.css"
