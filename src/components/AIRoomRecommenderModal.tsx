    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ocean-dark/80 backdrop-blur-md">
        <motion.div
          ...
          className="bg-cream border border-gold/40 rounded-3xl max-w-xl w-full p-6 sm:p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto text-charcoal"
        >
          <button
            onClick={onClose}
          ...
          <h3 className="font-serif text-2xl font-bold text-ocean">Find Your Perfect Suite</h3>
          ...
          {!recommendedRoom ? (
            <div className="space-y-6 mt-6">
              <div>
                <label className="block text-xs font-poppins font-bold uppercase text-ocean mb-2">Number of Guests</label>
              ...
              <div>
                <label className="block text-xs font-poppins font-bold uppercase text-ocean mb-2">Climate Preference</label>
            ...
            <div className="space-y-6 mt-6">
              <div className="p-4 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-4">
                <div className="relative h-48 rounded-2xl overflow-hidden">
                  ...
                  <span className="absolute top-3 left-3 bg-ocean text-gold text-[10px] uppercase font-poppins font-bold px-3 py-1 rounded-full border border-gold/40">
                    AI Top Match
                  </span>
                </div>

                <div>
                  <h4 className="font-serif font-bold text-ocean text-xl">{recommendedRoom.name}</h4>
                  <p className="text-xs text-charcoal/70 mt-1">{recommendedRoom.description}</p>
                </div>

                <div className="flex items-center justify-between pt-2 border-t border-gold/20">
                  <div>
                    <span className="text-xs text-charcoal/60 block font-poppins">Tariff / Night</span>
                    <span className="font-serif text-2xl font-bold text-ocean">₹{recommendedRoom.price}</span>
                  </div>

                  <span className="text-xs font-poppins text-gold-dark font-bold flex items-center gap-1">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="px-5 py-3 rounded-full border border-gold/30 text-ocean text-xs font-poppins font-semibold hover:bg-gold/10"
                >
                  Reset Preference
                </button>
