...
export const TajpurWeather: React.FC = () => {
  return (
    <div className="inline-flex items-center gap-3 px-3.5 py-1.5 rounded-full bg-ocean-dark/40 backdrop-blur-md border border-gold/30 text-xs text-sand font-poppins shadow-sm">
      <div className="flex items-center gap-1 text-gold">
        <Sun className="w-3.5 h-3.5 animate-spin-slow" />
        <span className="font-semibold text-white">28°C</span>
      </div>
      <span className="text-gold/40">|</span>
      <div className="flex items-center gap-1 text-sand/80 hidden sm:flex">
