    ...
    <div className="min-h-screen bg-sand-light pt-24 pb-20 text-charcoal">
      ...
      <section className="relative py-20 bg-ocean-dark text-sand overflow-hidden border-b-2 border-gold/30">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-gold text-xs font-poppins uppercase tracking-widest font-semibold block mb-2">24/7 Resort Concierge</span>
          <h1 className="font-serif font-extrabold tracking-wide text-white text-4xl sm:text-6xl font-bold text-white" style={{ textShadow: "0 3px 12px rgba(0,0,0,0.85), 0 2px 4px rgba(0,0,0,0.9)" }}>Contact & Location</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-3">
            ...
            <h4 className="font-serif font-bold text-ocean text-lg">Phone Numbers</h4>
            <div className="text-xs text-charcoal/80 space-y-1 font-poppins">
              <p><a href={`tel:${HOTEL_INFO.phonePrimary}`} className="hover:text-gold-dark font-bold">{HOTEL_INFO.phonePrimary}</a> (Primary)</p>
              <p><a href={`tel:${HOTEL_INFO.phoneSecondary}`} className="hover:text-gold-dark">{HOTEL_INFO.phoneSecondary}</a> (Secondary)</p>
              {HOTEL_INFO.phoneOther.map((num, i) => (
                <p key={i}><a href={`tel:${num}`} className="hover:text-gold-dark">{num}</a></p>
              ))}
            </div>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-3">
            ...
            <h4 className="font-serif font-bold text-ocean text-lg">Email & Messaging</h4>
            <div className="text-xs text-charcoal/80 space-y-2 font-poppins">
              <p><a href={`mailto:${HOTEL_INFO.email}`} className="hover:text-gold-dark font-bold">{HOTEL_INFO.email}</a></p>
              <a
          ...
          <div className="p-6 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-3">
            ...
            <h4 className="font-serif font-bold text-ocean text-lg">Property Address</h4>
            <p className="text-xs text-charcoal/80 leading-relaxed font-sans">
              {HOTEL_INFO.address}
            </p>
            <span className="inline-block text-[11px] text-gold-dark font-poppins font-bold">300m from Tajpur Beach Shore</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="p-8 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-6">
            <div className="border-b border-sand-dark pb-3">
              <span className="text-gold-dark text-xs font-poppins uppercase tracking-widest font-semibold block">Send a Message</span>
              <h3 className="font-serif text-2xl font-bold text-ocean">Inquire & Request Callback</h3>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4 font-poppins text-xs">
              <div>
                <label className="block font-semibold text-charcoal/80 mb-1.5">Your Full Name *</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block font-semibold text-charcoal/80 mb-1.5">Phone Number *</label>
                  <input
                    type="tel"
              ...
              <div>
                <label className="block font-semibold text-charcoal/80 mb-1.5">Inquiry Subject</label>
                <select
              ...
              <div>
                <label className="block font-semibold text-charcoal/80 mb-1.5">Message / Details</label>
                <textarea
                  rows={4}
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-full bg-ocean text-gold font-poppins font-bold text-xs uppercase tracking-wider hover:bg-ocean-dark transition-all flex items-center justify-center gap-2 shadow-md"
              >
