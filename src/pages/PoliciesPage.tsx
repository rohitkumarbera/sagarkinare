    ...
    <div className="min-h-screen bg-sand-light pt-24 pb-20 text-charcoal">
      ...
      <section className="relative py-20 bg-ocean-dark text-sand overflow-hidden border-b-2 border-gold/30">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          <span className="text-gold text-xs font-poppins uppercase tracking-widest font-semibold block">Legal & Resort Guidelines</span>
          <h1 className="font-serif font-extrabold tracking-wide text-white text-4xl sm:text-6xl font-bold text-white" style={{ textShadow: "0 3px 12px rgba(0,0,0,0.85), 0 2px 4px rgba(0,0,0,0.9)" }}>Resort Policies & Guidelines</h1>
        ...
        <div className="flex justify-center gap-3 mb-10">
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-xs font-poppins font-semibold uppercase tracking-wider transition-all ${
              activeTab === 'privacy'
                ? 'bg-ocean text-gold border border-gold/40 shadow-gold-glow'
                : 'bg-white text-charcoal border border-gold/20'
            }`}
          >
            Privacy Policy
          </button>
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-gold/30 shadow-luxury font-sans text-xs sm:text-sm leading-relaxed space-y-6">
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-4">
              <h2 className="font-serif font-bold text-2xl text-ocean border-b border-sand-dark pb-3">Privacy Policy</h2>
              <p>At Sagar Kinare Hotel & Resorts, guest privacy and data confidentiality are of paramount importance.</p>
              <h4 className="font-serif font-bold text-ocean text-base mt-4">1. Personal Information Collection</h4>
              ...
              <h4 className="font-serif font-bold text-ocean text-base mt-4">2. Data Protection</h4>
          ...
          {activeTab === 'terms' && (
            <div className="space-y-4">
              <h2 className="font-serif font-bold text-2xl text-ocean border-b border-sand-dark pb-3">Terms of Service & Rules</h2>
              <p>By booking a stay at Sagar Kinare Tajpur, guests agree to abide by the following resort rules:</p>
              <h4 className="font-serif font-bold text-ocean text-base mt-4">1. Check-In & Verification</h4>
              ...
              <h4 className="font-serif font-bold text-ocean text-base mt-4">2. Outside Food Policy</h4>
              ...
              <h4 className="font-serif font-bold text-ocean text-base mt-4">3. Property & Environment</h4>
          ...
          {activeTab === 'cancellation' && (
            <div className="space-y-4">
              <h2 className="font-serif font-bold text-2xl text-ocean border-b border-sand-dark pb-3">Cancellation & Refund Policy</h2>
