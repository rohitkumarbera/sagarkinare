      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-4">
            ...
            <h3 className="font-serif font-bold text-xl text-ocean">Night Beach Bonfire & BBQ</h3>
          ...
          <div className="p-8 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-4">
            ...
            <h3 className="font-serif font-bold text-xl text-ocean">Birthday & Anniversary Bashes</h3>
            <p className="text-xs text-charcoal/70 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl bg-white border border-gold/30 shadow-luxury space-y-4">
            ...
            <h3 className="font-serif font-bold text-xl text-ocean">Festive Get-Togethers</h3>
            <p className="text-xs text-charcoal/70 leading-relaxed">
        ...
        <div className="p-8 rounded-3xl bg-ocean text-sand border-2 border-gold/30 text-center space-y-4">
          ...
          <p className="text-xs text-sand/80 max-w-xl mx-auto">Contact our events coordinator to organize private group gatherings and bonfires.</p>
          <Link
            to="/contact"
